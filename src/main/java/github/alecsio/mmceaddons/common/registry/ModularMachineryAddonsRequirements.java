...
import github.alecsio.mmceaddons.common.hatch.mekanism.heat.RequirementTypeHeat;
...
public class ModularMachineryAddonsRequirements {
    ...
    public static final ResourceLocation KEY_REQUIREMENT_HEAT = new ResourceLocation(ModularMachineryAddons.MODID, "heat");
    ...
    public static void initRequirements() {
        ...
        if (Mods.MEKANISM.isPresent()) {
            ...
            registerRequirement(new RequirementTypeHeat(), KEY_REQUIREMENT_HEAT);
        }
    }
